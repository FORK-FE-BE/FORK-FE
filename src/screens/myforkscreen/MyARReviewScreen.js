...
export default function MyARReviewScreen() {
  ...
  const fetchReviews = async () => {
    try {
      const res = await axios.get(`${BASE_URL}/api/users/reviews`);
      setReviews(res.data);
    } catch (error) {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <TouchableOpacity onPress={() => navigation.goBack()}>
          <Image source={require('../../assets/images/arrow_back.png')} style={styles.arrow_back} />
        </TouchableOpacity>
        <Text style={styles.title}>AR리뷰 관리</Text>
        <View style={styles.headerSide} />
      </View>

      <Text style={styles.reviewCount}>내가 쓴 총 리뷰 {reviews.length}개</Text>
        ...
        renderItem={({ item }) => (
          <View style={styles.reviewBox}>
            <View style={styles.reviewTop}>
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                <Text style={styles.store}>{item.store}</Text>
                <Image source={require('../../assets/images/chevron_right.png')} style={styles.chevron} />
              </View>
              <TouchableOpacity style={styles.deleteBtn}>
                <Text style={styles.deleteText}>삭제</Text>
              </TouchableOpacity>
            ...
            {item.reply && (
              <View style={styles.replyContainer}>
                <Image source={require('../../assets/images/owner.png')} style={styles.profileCircle} resizeMode="contain" />
                <View style={styles.replyBubble}>
                  <Text style={styles.replyAuthor}>사장님 · {item.date}</Text>
                  <Text style={styles.replyContent}>{item.reply.content}</Text>
                </View>
